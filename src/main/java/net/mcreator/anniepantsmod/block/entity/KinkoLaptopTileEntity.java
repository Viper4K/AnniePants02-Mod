...
public class KinkoLaptopTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final SidedInvWrapper handler = new SidedInvWrapper(this, null);

	public KinkoLaptopTileEntity(BlockPos pos, BlockState state) {
		super(AnniepantsmodModBlockEntities.KINKO_LAPTOP.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(KinkoLaptopBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<KinkoLaptopTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<KinkoLaptopTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("kinko_laptop");
	}
	...
	public Component getDisplayName() {
		return Component.literal("AnnieVirus's Laptop");
	}
