...
public class KinkoLaptopProcedureProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity.isShiftKeyDown()) {
			...
			AnniepantsmodMod.queueServerWork(7, () -> {
				{
					BlockPos _bp = BlockPos.containing(x, y, z);
					BlockState _bs = AnniepantsmodModBlocks.KINKO_LAPTOP_CLOSED.get().defaultBlockState();
			...
			if (entity instanceof ServerPlayer _ent) {
				...
				_ent.openMenu(new MenuProvider() {
					...
					public Component getDisplayName() {
						return Component.literal("GSGui");
					}
					...
					public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
						return new GSGuiMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(_bpos));
					}
				}, _bpos);
			}
		}
