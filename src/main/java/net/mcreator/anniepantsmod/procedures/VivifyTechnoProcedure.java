...
@EventBusSubscriber
public class VivifyTechnoProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if (entity instanceof Pig) {
			...
			if (world instanceof ServerLevel _level) {
				Entity entityToSpawn = AnniepantsmodModEntities.TECHNOPIG.get().spawn(_level, BlockPos.containing(x, y, z), MobSpawnType.MOB_SUMMONED);
