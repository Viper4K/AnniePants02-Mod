...
public class JaneDoeEntity extends TamableAnimal implements GeoEntity {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(JaneDoeEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(JaneDoeEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(JaneDoeEntity.class, EntityDataSerializers.STRING);
	...
	public JaneDoeEntity(EntityType<JaneDoeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(2, new FollowOwnerGoal(this, 0.75, (float) 3, (float) 5) {
			@Override
			public boolean canUse() {
				double x = JaneDoeEntity.this.getX();
				double y = JaneDoeEntity.this.getY();
				double z = JaneDoeEntity.this.getZ();
				Entity entity = JaneDoeEntity.this;
				Level world = JaneDoeEntity.this.level();
		...
		this.goalSelector.addGoal(5, new MeleeAttackGoal(this, 1.2, false) {
			...
			protected boolean canPerformAttack(LivingEntity entity) {
				...
				return this.isTimeToAttack()
					&& this.mob.distanceToSqr(entity) < (reach * reach + entity.getBbWidth())
	...
	public boolean isAlliedTo(Entity other) {
		...
		if (owner != null) {
			...
			if (other instanceof TamableAnimal pet && owner == pet.getOwner()) return true;
		}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		JaneDoeEntity retval = AnniepantsmodModEntities.JANE_DOE.get().create(serverWorld);
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(JaneDoeEntity.RemovalReason.KILLED);
